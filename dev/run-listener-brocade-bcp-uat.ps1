$env:HITRACK_INFLUX_URL    = 'http://127.0.0.1:8187'
$env:HITRACK_INFLUX_TOKEN  = 'unifiedops-dev-token-brocade-bcp'
$env:HITRACK_INFLUX_ORG    = 'HDFC'
$env:HITRACK_INFLUX_BUCKET = 'Brocade_BCP_Bucket'
$env:HITRACK_LISTEN_HOST   = '127.0.0.1'
$env:HITRACK_LISTEN_PORT   = '5215'
$env:HITRACK_TEST_MODE     = '1'

# Heartbeat (BCP site - Brocade listener)
...
& "$root\.venv\Scripts\python.exe" "$root\listener\syslog_trap_listener_bcp_n_uat.py"
