$env:HITRACK_INFLUX_URL    = 'http://127.0.0.1:8386'
$env:HITRACK_INFLUX_TOKEN  = 'unifiedops-dev-token-dell-cdvl'
$env:HITRACK_INFLUX_ORG    = 'HDFC'
$env:HITRACK_INFLUX_BUCKET = 'Dell_CDVL_Bucket'
$env:HITRACK_LISTEN_HOST   = '127.0.0.1'
$env:HITRACK_LISTEN_PORT   = '5414'
...
& "$root\.venv\Scripts\python.exe" "$root\listener\syslog_trap_listener_dell_cdvl.py"
