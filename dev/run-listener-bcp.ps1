$env:HITRACK_INFLUX_URL    = 'http://127.0.0.1:8087'
$env:HITRACK_INFLUX_TOKEN  = 'unifiedops-dev-token-bcp'
$env:HITRACK_INFLUX_ORG    = 'HDFC'
$env:HITRACK_INFLUX_BUCKET = 'Hitachi_BCP_Bucket'
$env:HITRACK_LISTEN_HOST   = '127.0.0.1'
$env:HITRACK_LISTEN_PORT   = '5515'
...
& "$root\.venv\Scripts\python.exe" "$root\listener\syslog_trap_listener_bcp.py"
